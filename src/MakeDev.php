...
final class MakeDev
{
    ...
    public $chNFe;
    public $xml;
    protected $flagIS = false;
    protected $flagIBSCBS = false;
    protected $flagMono = false;
    protected $calculationMethod = 2;
    protected $version;
    protected $mod = '55';
    protected $csrt;
    ...
    protected $aGPagAntecipado = [];
    protected $aRefDFeAnt = [];
    protected $aGALCZFMCBS = [];
